		...
		<div>
			...
			<div>
				...
				<div class="grid cols-3 spacing-15">
					...
					<div class="colspan-2">
						<label>
							Title 
							<input type="text" name="thirdSectionTitle" id="thirdSectionTitle" class="form-element block"  value="<?php echo $this->settingValue["thirdSectionTitle"]; ?>"/>
						</label>
						<br />
						<label>
							<textarea placeholder="Description" id="thirdSectionDesc" data-rule="text" rows="3" class="form-element block v-resize" name="thirdSectionDesc"><?php echo $this->settingValue["thirdSectionDesc"]; ?></textarea>
						</label>
						<br />
						<label>
							<textarea placeholder="Description Below Image" id="thirdSectionDesc1" data-rule="text" rows="3" class="form-element block v-resize" name="thirdSectionDesc1"><?php echo $this->settingValue["thirdSectionDesc1"]; ?></textarea>
						</label>
					</div>
				</div>
			...
			<div>
				...
				<div>
					...
					<br />
						<label>
							<textarea placeholder="Description" id="textFourthSection"  rows="3" class="form-element block v-resize" name="textFourthSection"><?php echo $this->settingValue["textFourthSection"]; ?></textarea>
						</label>
				</div>
