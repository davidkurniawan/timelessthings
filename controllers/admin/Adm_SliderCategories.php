...
class Adm_SliderCategories extends Adm_Base
{
	protected $terms,  $mainPath = 'news';
	
	protected function onPageStart()
	{
		parent::onPageStart();
		
		$this->title='Slider Categories';
		$this->terms = Taxonomy::getCategoriesByContentType('slider',false);
		$this->contentFilename = $this->templatePath  . '/slider-categories.php';
	}
